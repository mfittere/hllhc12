...
optics.open('inj_old/twiss_ir6b1.tfs').plotap(ref=9.5)
a7b1=optics.open('inj_new/ap_ir6b1.tfs')
plot(a7b1.s,a7b1.n1,'r')

optics.open('inj_old/twiss_ir6b2.tfs').plotap(ref=9.5)
a7b2=optics.open('inj_new/ap_ir6b2.tfs')
